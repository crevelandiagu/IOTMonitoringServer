...
MQTT_USER = "="  # "UsuarioMQTT"
MQTT_PASSWORD = "="  # "ContraseñaMQTT"
# sKE6CfvB4b8B
'''
Topicos de suscripción y publicación
'''
BASE_TOPIC = "Australia/Victoria/Melbourne/" + \
...
def measure_data():
    ...
    # print("\tluminosidad: {}luminosidad".format(moisture))
    test_ = random.uniform(10, 30)
    print("\ttest2: {}test2".format(test_))
    mqtt_publish(MQTT_PUB_TOPIC, json.dumps({
        "temperatura": temperature,
        "humedad": moisture,
        # "luminosidad": random.uniform(10, 30),
        "test2": test_,
    }))
